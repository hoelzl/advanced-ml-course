...
c.NotebookApp.password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$BBchSWdhEZ5K93/Yx/sfDw$wtI+JhvqUhNY47aH4O3eXw'
...
#  Choices: any of ['sha384', 'sha224', 'sha3_384', 'sha256', 'blake2b', 'sha512', 'blake2s', 'md5', 'sha1', 'sha3_512', 'sha3_256', 'sha3_224']
#  Default: 'sha256'
